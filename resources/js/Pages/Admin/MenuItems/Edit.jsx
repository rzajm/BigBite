...
export default function Edit({ menuItem, categories = [], allergens = [] }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.menu-items.update', menuItem.id));
    };
    ...
    return (
        <AdminLayout title="Edit Menu Item">
            <Head title="Admin - Edit Menu Item" />
            ...
            <div className="max-w-3xl">
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm p-8 space-y-6">
                    ...
                    <div>
                        ...
                        {menuItem.image && <p className="text-xs text-gray-400 mt-1">Current: {menuItem.image}</p>}
                    </div>
