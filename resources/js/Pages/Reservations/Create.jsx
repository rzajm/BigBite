            ...
            <section className="bg-bb-dark py-16 sm:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-400 max-w-xl mx-auto">
                        Reserve your table and enjoy our restaurant-quality burgers in a warm, welcoming atmosphere
                    </p>
                </div>
            </section>
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    {!data.time && (
                                        <p className="text-xs text-gray-400 mt-1">Select a time slot</p>
                                    )}
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <p className="text-xs text-gray-400 text-center mt-4">
                                ...
                                For large groups (8+), please call us directly.
                            </p>
                        </div>
                    )}
                </div>
